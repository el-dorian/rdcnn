...
class GrammarHandler
{
    ...
    public static function toLatin($name): string
    {
        $input = ['А', 'Т'];
        $replace = ['A', 'T'];
    ...
    public static function getCenter(mixed $examinationId): string
    {
        if(str_starts_with($examinationId, "A")){
            return 'Аврора';
        }
        if(str_starts_with($examinationId, "T")){
            return 'КТ';
        }
        return 'НВН';
    }
